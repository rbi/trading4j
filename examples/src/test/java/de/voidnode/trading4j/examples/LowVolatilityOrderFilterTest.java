...
public class LowVolatilityOrderFilterTest {
    ...
    private final OrderFilter<CandleStick<M1>> requiresLowVolatility = new LowVolatilityOrderFilter<>(
            new Ratio(10, PERCENT));
    private final OrderFilter<CandleStick<M1>> requiresHighVolatility = new LowVolatilityOrderFilter<>(
